        ...
        if(arguments?.getString("key")=="update"){
            ...
            binding.buttonSave.setOnClickListener {
                CoroutineScope(Dispatchers.IO).launch {
                    db?.experienceDao()?.updateExperience(Experience(id,binding.editTitle.text.toString(),binding.editDescription.text.toString()))
            ...
            binding.buttonDelete.setOnClickListener {
                CoroutineScope(Dispatchers.IO).launch {
                    db?.experienceDao()?.deleteExperience(Experience(id,
                        arguments?.getString("title")!!, arguments?.getString("description")!!
                    ))
            ...
            binding.buttonSave.setOnClickListener {
                CoroutineScope(Dispatchers.IO).launch {
                    db?.experienceDao()?.addExperience(Experience(0,binding.editTitle.text.toString(),binding.editDescription.text.toString()))
